#
#  Be sure to run `pod spec lint ReusableExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Aleksandr Pronin" => "pronin.alx@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/adviqo-GmbH/iOSReusableExtensions.git", :tag => "#{s.version}" }
  ...
  # s.resource_bundles = {
  #     'ReusableExtensions' => [
  #         'ReusableExtensions/**/*.json',
  #         'ReusableExtensions/**/*.xcassets',
  #         'ReusableExtensions/**/*.xib'
  #     ]
  #   }
